...
const (
	...
	RecipeService_ChangeVisibility_FullMethodName = "/recipe.RecipeService/ChangeVisibility"
)
...
type RecipeServiceClient interface {
	...
	ChangeVisibility(ctx context.Context, in *ChangeVisibilityRequest, opts ...grpc.CallOption) (*ChangeVisibilityResponse, error)
}
...
func (c *recipeServiceClient) ChangeVisibility(ctx context.Context, in *ChangeVisibilityRequest, opts ...grpc.CallOption) (*ChangeVisibilityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChangeVisibilityResponse)
	err := c.cc.Invoke(ctx, RecipeService_ChangeVisibility_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RecipeServiceServer interface {
	...
	ChangeVisibility(context.Context, *ChangeVisibilityRequest) (*ChangeVisibilityResponse, error)
...
func (UnimplementedRecipeServiceServer) ChangeVisibility(context.Context, *ChangeVisibilityRequest) (*ChangeVisibilityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ChangeVisibility not implemented")
}
...
func _RecipeService_ChangeVisibility_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChangeVisibilityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RecipeServiceServer).ChangeVisibility(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RecipeService_ChangeVisibility_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecipeServiceServer).ChangeVisibility(ctx, req.(*ChangeVisibilityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RecipeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RecipeService_ChangeVisibility_Handler,
		},
	},
